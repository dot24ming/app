 ...
 * @author 吴伟佳 
 */
class Service_Data_SelFeedback {
    private $objDaoSelFeedback;
    public function __construct(){
        $this->objDaoSelFeedback = new Dao_SelFeedback();
    }
     //set注入
	...
	public function doSelFeedback($arrInput){
		$strData = $this->objDaoSelFeedback->doSelFeedback($arrInput);
		return $strData;
	}
