 ...
 * @author 吴伟佳 
 */
class Service_Data_InsCustomer {
    private $objDaoInsCustomer;
    public function __construct(){
        $this->objDaoInsCustomer = new Dao_InsCustomer();
    }
     //set注入
	...
	public function doInsCarInfo($arrInput,$user_id){
		$strData = $this->objDaoInsCustomer->doInsCarInfo($arrInput,$user_id);
		return $strData;
	}
	public function doInsCustomer($arrInput){
		$strData = $this->objDaoInsCustomer->doInsCustomer($arrInput);
		return $strData;
	}
	public function doCheckUser($user_id)
	{
		$strData = $this->objDaoInsCustomer->doCheckUser($user_id);
		return $strData;
	}
