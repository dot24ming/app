 ...
 * @author 吴伟佳 
 */
class Service_Data_StockMag {
    private $objDaoStockMag;
    public function __construct(){
        $this->objDaoStockMag = new Dao_StockMag();
    }
     //set注入
	...
	public function doInsInstock($arrInput){
		$strData = $this->objDaoStockMag->doInsInstock($arrInput);
		return $strData;
	}
	public function doInsOutstock_quick($arrInput){
		$strData = $this->objDaoStockMag->doInsOutstock_quick($arrInput);
		return $strData;
	}
	public function doInsOutstock($arrInput){
		$strData = $this->objDaoStockMag->doInsOutstock($arrInput);
		return $strData;
	}
	public function doInsTransfer($arrInput){
		$strData = $this->objDaoStockMag->doInsTransfer($arrInput);
		return $strData;
	}
	public function doInsInventory($arrInput){
		$strData = $this->objDaoStockMag->doInsInventory($arrInput);
		return $strData;
	}
	public function doInsPurchase($arrInput){
		$strData = $this->objDaoStockMag->doInsPurchase($arrInput);
		return $strData;
	}
	public function doInsQuote($arrInput){
		$strData = $this->objDaoStockMag->doInsQuote($arrInput);
		return $strData;
	}
