 ...
 * @author 吴伟佳 
 */
class Service_Data_GetProvince {
    private $objDaoGetProvince;
    public function __construct(){
        $this->objDaoGetProvince = new Dao_GetProvince();
    }
     //set注入
	...
	public function doGetProvince($arrInput){
		$strData = $this->objDaoGetProvince->doGetProvince($arrInput);
		return $strData;
	}
