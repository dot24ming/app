 ...
 * @author 吴伟佳 
 */
class Service_Data_GetBrand {
    private $objDaoGetBrand;
    public function __construct(){
        $this->objDaoGetBrand = new Dao_GetBrand();
    }
     //set注入
	...
	public function doGetBrand($arrInput){
		$strData = $this->objDaoGetBrand->doGetBrand($arrInput);
		return $strData;
	}
