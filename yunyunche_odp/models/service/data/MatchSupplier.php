 ...
 * @author 吴伟佳 
 */
class Service_Data_MatchSupplier {
    private $objDaoMatchSupplier;
    public function __construct(){
        $this->objDaoMatchSupplier = new Dao_MatchSupplier();
    }
     //set注入
	...
	public function doMatchSupplier($arrInput){
		$strData = $this->objDaoMatchSupplier->doMatchSupplier($arrInput);
		return $strData;
	}
