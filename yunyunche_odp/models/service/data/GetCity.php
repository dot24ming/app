 ...
 * @author 吴伟佳 
 */
class Service_Data_GetCity {
    private $objDaoGetCity;
    public function __construct(){
        $this->objDaoGetCity = new Dao_GetCity();
    }
     //set注入
	...
	public function doGetCity($arrInput){
		$strData = $this->objDaoGetCity->doGetCity($arrInput);
		return $strData;
	}
