 ...
 * @author 吴伟佳 
 */
class Service_Data_GetSeries {
    private $objDaoGetSeries;
    public function __construct(){
        $this->objDaoGetSeries = new Dao_GetSeries();
    }
     //set注入
	...
	public function doGetSeries($arrInput){
		$strData = $this->objDaoGetSeries->doGetSeries($arrInput);
		return $strData;
	}
