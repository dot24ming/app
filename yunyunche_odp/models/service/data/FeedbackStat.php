 ...
 * @author 吴伟佳 
 */
class Service_Data_FeedbackStat {
    private $objDaoFeedbackStat;
    public function __construct(){
        $this->objDaoFeedbackStat = new Dao_FeedbackStat();
    }
     //set注入
	...
	public function doFeedbackStat($gt_score,$lt_score){
		$strData = $this->objDaoFeedbackStat->doFeedbackStat($gt_score,$lt_score);
		return $strData;
	}
