 ...
 * @author 吴伟佳
 */
class Service_Page_SelMessage {
    private $objServiceDataSelMessage;
    public function __construct(){
        $this->objServiceDataSelMessage = new Service_Data_SelMessage();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataSelMessage->doSelMessage($arrInput);
			$arrResult['data']['push_history'] = $strData['result'];
			$arrResult['data']['push_count'] = $strData['count'];
