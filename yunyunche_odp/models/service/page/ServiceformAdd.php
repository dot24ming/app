 ...
 * @author ycx
 */
class Service_Page_ServiceformAdd {
    ...
    public function execute($arrInput){
		...
		try{
			...
			//}else{
				//以下获取数据的方式提供3种示例，3选1
				//1. 调用本地DS
				Bd_Log::debug('pageinfo');
				$strData = $this->objServiceDataformAdd->addServiceformAdd($arrInput);
				$strData = $this->objServiceDataformAdd->getServiceCate(0);
				Bd_Log::debug('pageinfo'.(json_encode($strData)));
