 ...
 * @author 吴伟佳
 */
class Service_Page_GetCity {
    private $objServiceDataGetCity;
    public function __construct(){
        $this->objServiceDataGetCity = new Service_Data_GetCity();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataGetCity->doGetCity($arrInput);
