 ...
 * @author 吴伟佳
 */
class Service_Page_GetDistrict {
    private $objServiceDataGetDistrict;
    public function __construct(){
        $this->objServiceDataGetDistrict = new Service_Data_GetDistrict();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataGetDistrict->doGetDistrict($arrInput);
