 ...
 * @author 吴伟佳
 */
class Service_Page_MatchGoods {
    private $objServiceDataMatchGoods;
    public function __construct(){
        $this->objServiceDataMatchGoods = new Service_Data_MatchGoods();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataMatchGoods->doMatchGoods($arrInput);
