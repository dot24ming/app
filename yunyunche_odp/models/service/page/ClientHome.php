<?php
/**
 * @name Service_Page_ClientHome
 * @desc ClientHome page service, 和action对应，组织页面逻辑，组合调用data service
 * @author ycx
 */
class Service_Page_ClientHome {
    private $objServiceDataSample;
    public function __construct(){
        $this->objServiceDataSample = new Service_Data_Mobile();
    }
    //set注入
