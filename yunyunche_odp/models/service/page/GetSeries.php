 ...
 * @author 吴伟佳
 */
class Service_Page_GetSeries {
    private $objServiceDataGetSeries;
    public function __construct(){
        $this->objServiceDataGetSeries = new Service_Data_GetSeries();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataGetSeries->doGetSeries($arrInput);
