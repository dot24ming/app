 ...
 * @author 吴伟佳
 */
class Service_Page_MatchSupplier {
    private $objServiceDataMatchSupplier;
    public function __construct(){
        $this->objServiceDataMatchSupplier = new Service_Data_MatchSupplier();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataMatchSupplier->doMatchSupplier($arrInput);
