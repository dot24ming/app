 ...
 * @author 吴伟佳
 */
class Service_Page_GetBrand {
    private $objServiceDataGetBrand;
    public function __construct(){
        $this->objServiceDataGetBrand = new Service_Data_GetBrand();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataGetBrand->doGetBrand($arrInput);
