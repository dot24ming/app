 ...
 * @author 吴伟佳
 */
class Service_Page_GetProvince {
    private $objServiceDataGetProvince;
    public function __construct(){
        $this->objServiceDataGetProvince = new Service_Data_GetProvince();
    }
    //set注入
    ...
    public function execute($arrInput){
		...
		try{
			...
			$strData = $this->objServiceDataGetProvince->doGetProvince($arrInput);
