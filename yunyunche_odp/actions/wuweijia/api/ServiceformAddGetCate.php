 ...
 * @author yincunxiang
 */
class Action_ServiceformAddGetCate extends Ap_Action_Abstract {
	...
	public function execute() {
	    ...
	    //3. call PageService
		$objServicePageServiceformAddGetCate = new Service_Page_ServiceformAddGetCate();
		$arrPageInfo = $objServicePageServiceformAddGetCate->execute($arrInput);
