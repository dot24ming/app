 ...
 * @author 吴伟佳
 */
class Action_InsPurchase extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		$form_status = Tool_Const::$Purchase_status["reviewing"];
		...
		/*
		$arrInput['purchase_type'] = Tool_Const::$Purchase_type["maintenance"];
		$arrInput['censor'] = 'wuweijia2';
		$arrInput['purchase_man'] = 'wuweijia3';
		$arrInput['remarks'] = 'remarks';
		$arrInput['total_cost'] = 1992.3;
		$arrInput['total_count'] = 20;

		$arrInput['maintenance_id'] = 1;
		$arrInput['car_id'] = 2;

		$arrInput['purchase_items'] = array();
		...
		//$arrInputItem['car_id'] = 2;
		$arrInputItem['maintenance_item'] = "123";

		array_push($arrInput['purchase_items'],$arrInputItem);
		...
		*/
		...
		$arrPageInfo = $objServicePageLogcheck->execute_ins_purchase($arrInput);
