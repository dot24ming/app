...
class Action_InStock extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		if(!isset($arrInput["form_id"]) or $arrInput["form_id"]==""){
			...
			$select_result = $db_client->select(Tool_Util::getStoreTable('model_goods_storage'),'storage_status,time','storage_id='.$arrInput["form_id"],NULL,NULL);
		...
		$select_result = $db_client->select(Tool_Util::getStoreTable('model_store_info'),'name',' store_id='.$admin_store_id,NULL,NULL);
