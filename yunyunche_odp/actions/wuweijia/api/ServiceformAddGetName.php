 ...
 * @author yincunxiang
 */
class Action_ServiceformAddGetName extends Ap_Action_Abstract {
	...
	public function execute() {
	    ...
	    //3. call PageService
		$objServicePageServiceformAdd = new Service_Page_ServiceformAddGetName();
