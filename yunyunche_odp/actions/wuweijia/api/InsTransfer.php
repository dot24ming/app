 ...
 * @author 吴伟佳
 */
class Action_InsTransfer extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		/*
		$arrInput['in_warehouse_id'] = "12";
		$arrInput['in_warehouse_name'] = "a";
		$arrInput['out_warehouse_id'] = "3";
		$arrInput['out_warehouse_name'] = "b";
		$arrInput['warehouse_auditor'] = "wuweijia";
		$arrInput['transfer_man'] = "wuweijia2";
		$arrInput['remarks'] = "www";

		$arrInput['sum_count'] = "22";
		$arrInput['sum_price'] = "29.3";

		$arrInput["transfer_items"] = array();
		...
		$arrInputItem['sum'] = $arrInputItem['unit_price']*$arrInputItem['count'];
		$arrInputItem['remarks'] = '';

		array_push($arrInput["transfer_items"],$arrInputItem);
		*/
		//return Tool_Util::returnJson($arrInput,'','');

	    //3. call PageService
		$objServicePageLogcheck = new Service_Page_StockMag();
		$arrPageInfo = $objServicePageLogcheck->execute_ins_transfer($arrInput);
