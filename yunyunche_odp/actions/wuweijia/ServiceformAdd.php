 ...
 * @author yincunxiang
 */
class Action_ServiceformAdd extends Ap_Action_Abstract {
	...
	public function execute() {
	    ...
	    //3. call PageService
		$objServicePageServiceformAdd = new Service_Page_ServiceformAdd();
		//echo 'hello, world';
	    ...
	    //$tpl->display('admin/page/serviceformadd.tpl');
		Tool_Util::displayTpl($arrOutput['data'], 'admin/page/serviceformadd.tpl');
