 ...
 * @author 吴伟佳
 */
class Action_GetDistrict extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		$arrRequest = Saf_SmartMain::getCgi();
		$arrInput = $arrRequest['get'];
		if(!isset($arrInput['province'])){
			return Tool_Util::returnJson(NULL,101,'params error, check province');
		}
		if(!isset($arrInput["city"])){
			return Tool_Util::returnJson(NULL,101,'params error, check city');
		}
		$objServicePageLogin = new Service_Page_GetDistrict();
