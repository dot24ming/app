 ...
 * @author 吴伟佳
 */
class Action_MobileServiceDetail extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		Tool_Util::displayTpl(array('userName' => $userName, 'storeName'=>$storeName), 'mobile/page/service/detail.tpl');
	}
