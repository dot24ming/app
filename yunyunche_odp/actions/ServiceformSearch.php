...
class Action_ServiceformSearch extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
	    ...
	    //3. call PageService
		$objServicePageServiceformSearch = new Service_Page_ServiceformSearch();
	    ...
	    //$tpl->display('admin/page/searchserviceform.tpl');
		Tool_Util::displayTpl($arrOutput, 'admin/page/searchserviceform.tpl');
