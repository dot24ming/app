 ...
 * @author 吴伟佳
 */
class Action_InsOutstock extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		/*
		$arrInput['outstock_type'] = Tool_Const::$Outstock_type["maintenance"];
		$arrInput['outstock_department'] = 'wu depart';
		$arrInput['warehouse_auditor'] = 'wuweijia2';
		$arrInput['delivery_man'] = 'wuweijia3';
		$arrInput['remarks'] = 'remarks';
		$arrInput['sum_price'] = 1992.3;
		$arrInput['sum_net_price'] = 1500;
		$arrInput['sum_count'] = 20;
		$arrInput['outstock_items'] = array();
		...
		$arrInputItem['storage_price'] = 92.3;
		$arrInputItem['shipment_price']=102.3;
		$arrInputItem['count'] = 20;
		$arrInputItem['sum'] = ($arrInputItem['shipment_price'] - $arrInputItem['storage_price'] ) * $arrInputItem['count'];
		...
		array_push($arrInput['outstock_items'],$arrInputItem);
