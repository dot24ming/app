...
class Action_MatchCar extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		//$select_result = $db_client->select(Tool_Util::getStoreTable('car_info'),'*','binary plate_number like "%'.$arrInput["plate_number"].'%"',NULL,$limit_str);
		$select_result = $db_client->select(Tool_Util::getStoreTable('car_info'),'*','plate_number like "%'.$arrInput["plate_number"].'%"',NULL,$limit_str);
