 ...
 * @author 吴伟佳
 */
class Action_InsInventory extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		$form_status = Tool_Const::$Inventory_status["reviewing"];
		...
		/*
		//TODO
		$arrInput['goods_category'] = 'category';
		$arrInput['filter'] = array();
		array_push($arrInput['filter'],'zero');

		//$arrInput['warehouse_auditor'] = 'wuweijia2';
		//$arrInput['inventory_man'] = 'wuweijia3';
		$arrInput['censor'] = 'wuweijia2';
		$arrInput['storer'] = 'wuweijia3';
		$arrInput['remarks'] = 'remarks';

		$arrInput['sum_instock_count'] = 20;
		$arrInput['sum_inventory_count'] = 21;

		$arrInput['sum_count'] = $arrInput['sum_inventory_count'] - $arrInput['sum_instock_count'];
		$arrInput['sum_price'] = 1992.3; // compute one by one

		$arrInput['inventory_items'] = array();
		...
		$arrInputItem['instock_count'] = 20;
		$arrInputItem['inventory_count'] = 21;
		$arrInputItem['sum_count'] = $arrInputItem['inventory_count'] - $arrInputItem['instock_count'];
		$arrInputItem['sum_price'] = $arrInputItem['sum_count'] * $arrInputItem['unit_price'];
		$arrInputItem['remarks'] = "remarks item";

		array_push($arrInput['inventory_items'],$arrInputItem);
		...
		*/
		...
		$arrPageInfo = $objServicePageLogcheck->execute_ins_inventory($arrInput);
