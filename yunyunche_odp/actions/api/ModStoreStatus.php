 ...
 * @author 吴伟佳
 */
class Action_ModStoreStatus extends Ap_Action_Abstract {
	...
	public function execute() {
	    ...
	    //3. call PageService
		$objServicePageLogcheck = new Service_Page_ModStore();
		$arrPageInfo = $objServicePageLogcheck->modStatus($arrInput);
