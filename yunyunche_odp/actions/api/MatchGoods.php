 ...
 * @author 吴伟佳
 */
class Action_MatchGoods extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		$arrInput['name'] = urldecode($arrInput['name']);
		//var_dump($arrInput);

	    //3. call PageService
		$objServicePageLogin = new Service_Page_MatchGoods();
		...
		return Tool_Util::returnJson($arrOutput['data'],$arrOutput['errno'],'');
