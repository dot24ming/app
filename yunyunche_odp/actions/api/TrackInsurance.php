 ...
 * @author 吴伟佳
 */
class Action_TrackInsurance extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		$objServicePageLogin = new Service_Page_TrackCustomer();
		$arrPageInfo = $objServicePageLogin->trackInsurance($arrInput);
	    ...
	    $tpl->display('yunyunche_odp/discover_customer.tpl');
