 ...
 * @author 吴伟佳
 */
class Action_DiscoverCustomer extends Ap_Action_Abstract {
	...
	public function execute() {
		...
		*/
		...
		$objServicePageLogin = new Service_Page_DiscoverCustomer();
		...
		Tool_Util::displayTpl($data, 'admin/page/discovercustomer.tpl');
		exit;
	    ...
	    $tpl->display('admin/page/discovercustomer.tpl');
